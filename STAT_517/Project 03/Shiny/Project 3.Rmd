...
The second criteria check was the total number of "pass" questions in the positive, negative and generic symptoms sections. To receive a "pass" in the positive and negative symptoms sections at least 5 out of the 7 symptoms must be a "pass". To receive a "pass" in the generic symtoms section at least 10 out of the 16 must be a "pass".
...
receive at least five passes out of the seven questions for the positive and negative symptoms and at least ten out of the sixteen questions for the generic symptoms. 

The criteria for a physician to pass the PANSS training workshop required them to  involve receiving a score that is within +1 or -1 of the expert's rating and 

## Including Plots
```{r pressure, echo=FALSE}
kable(dafr_physician_results)
```
