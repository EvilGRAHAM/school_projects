...
```
This returned values with insignificant p-values
...
pander(anova(banana_reg_02, banana_reg_01), caption = "Analysis of Variance Table: Model 1 vs. Model 2")
pander(anova(banana_reg_03, banana_reg_01), caption = "Analysis of Variance Table: Model 1 vs. Model 3")
pander(anova(banana_reg_03, banana_reg_02), caption = "Analysis of Variance Table: Model 2 vs. Model 3")
...
## Removal of Outliers
The second part of the analysis included removing any potential outliers from the analysis. In this case, one outlier was removed.


# Recommendations
Using the first set of data before the outlier was removed, it can be determiend that the best way to predict the weight of a banana is by measuring the radius of the banana. The model that is then used for banana weight prediction is the following:
$$
