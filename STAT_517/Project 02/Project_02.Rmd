...
\begin{equation}
  log(Weight) = log(length) + log(radius) + log(circumference)
\end{equation}
In the second model the predictor variable, circumference, was removed. 
\begin{equation}
  log(Weight) = log(length) + log(radius) + log(circumference)
\end{equation}
The third model considered only one predictor, radius.
\begin{equation}
  log(Weight) = log(radius)
\end{equation}
The fourth model considered the predictor, length.
\begin{equation}
