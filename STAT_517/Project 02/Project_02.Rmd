...
-Conclusions drawn
The intent of this study was to determine the most effective regression model to predict the weight of a banana using external measurements. This study also demonstrated multiple techniques for developing regression models. Some of the techniques that were used were, elimation of variables and removal of outliers. These models were then examined to demonstrate their effectiveness for predicting the weight of a banana.
